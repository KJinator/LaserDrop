...
int main(int argc, char *argv[]) {
    ...
    /***********   get_ith_bit and set_ith_bit Testing   ************/
    printf("\nget_ith_bit and set_ith_bit Testing\n\n");
    char test [2];
    char ham [2];
    ham[0] = 0;
    ...
    set_ith_bit(test, 1, 0);
    set_ith_bit(&test[1], 0, 0);
    ...
    printf("\nHAMMING ENCODING TESTING\n\n");
    sixteen_eleven_hamming(test, ham);

    printf("%x %x (Should be 4B 1E)\n\n", ham[0], ham[1]);
