...
static const uint32_t ACK = 0xB1B2B3B4;
static const uint32_t DONE = 0xA1A2A3A4;
static const uint32_t START = 0xC1C2C3C4;

void read_state_sender(FT_HANDLE ftHandle) {
    char RxBuffer [1024];
    char *errorBuffer;
    DWORD BytesRecieved;
    FT_STATUS ftStatus;
    uint32_t *RxBuffer_int = &RxBuffer;
